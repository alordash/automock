...
///
/// # Safety:
/// Mock objects store arguments passed to them for their entire lifetime. automock follows
/// assumption that mock object should not outlive arguments passed to it. This requires treating
/// all types and references as having a special lifetime [`automock_proc_macro::constants::DEFAULT_ARG_LIFETIME`]
