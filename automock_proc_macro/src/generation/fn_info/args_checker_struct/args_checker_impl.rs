...
pub(crate) fn generate(
    ...
    let result = ItemImpl {
        ...
        generics,
        trait_: Some((
            path::new_global(span, for_generated::new("IArgsChecker")),
            Token![for](span),
        )),
        ...
        output: ReturnType::Type(
            ...
            Box::new(Type::Path(r#type::vec_of(
                ...
                Type::Path(r#type::path::new_global(
                    span,
                    for_generated::new("ArgCheckResult"),
                )),
            ))),
        ),
    };

    let use_i_debug_printer_stmt = for_generated::glob_usage(span, "arg_printing");
